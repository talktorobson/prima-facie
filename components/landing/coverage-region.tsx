        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-landing-stone leading-relaxed mb-4">
              Nosso escritório está sediado em Cerquilho/SP e atende empresas em todo o eixo
              Sorocaba — Campinas — Piracicaba, incluindo Tatuí, Tietê, Indaiatuba e cidades vizinhas.
            </p>
            <p className="text-landing-stone leading-relaxed mb-10">
              Atuamos também em demandas em todo o Estado de São Paulo e, para casos específicos,
