-- =============================================
-- PRIMA FACIE SEED DATA - STEP 1: CORE TABLES (FIXED)
...
-- =============================================
-- SEED MATTERS (LEGAL CASES) - FIXED COLUMN COUNT
-- =============================================
...
INSERT INTO matters (id, law_firm_id, matter_type_id, matter_number, title, description, 
                    ...
                    total_billed, total_paid, outstanding_balance, notes) VALUES

-- Dávila Reis Advocacia cases
('55555555-5555-5555-5555-555555555001', '123e4567-e89b-12d3-a456-426614174000', '11111111-1111-1111-1111-111111111001', 'LAB-2024-001', 'Ação Trabalhista - Carlos Silva vs Empresa XYZ', 'Reclamação trabalhista por verbas rescisórias não pagas', '2ª Vara do Trabalho de São Paulo', 'São Paulo', 'SP', '1234567-89.2024.5.02.0001', 'Empresa XYZ LTDA', 'active', 'high', '2024-01-15', 'contingency', null, null, 4500.00, 3200.00, 1300.00, 'Caso com boa chance de acordo'),
...
('55555555-5555-5555-5555-555555555004', '123e4567-e89b-12d3-a456-426614174000', '11111111-1111-1111-1111-111111111005', 'COB-2024-004', 'Cobrança - Ana Paula vs Prestadora ABC', 'Ação de cobrança por serviços não pagos', '15ª Vara Cível de São Paulo', 'São Paulo', 'SP', '7777888-99.2024.8.26.0100', 'Prestadora ABC LTDA', 'active', 'medium', '2024-02-20', 'contingency', null, null, 3200.00, 1600.00, 1600.00, 'Em fase de citação do réu'),

('55555555-5555-5555-5555-555555555005', '123e4567-e89b-12d3-a456-426614174000', '11111111-1111-1111-1111-111111111002', 'CONT-2024-005', 'Revisão Contrato - TechStart', 'Revisão de contratos de prestação de serviços', null, null, null, null, null, 'active', 'low', '2024-03-01', 'hourly', 400.00, null, 2400.00, 1800.00, 600.00, 'Contratos em análise'),

-- Silva & Associados cases
('66666666-6666-6666-6666-666666666001', '234e4567-e89b-12d3-a456-426614174001', '22222222-2222-2222-2222-222222222001', 'EMP-2024-001', 'Consultoria Empresarial - Indústria Brasileira', 'Consultoria para reestruturação societária', null, null, null, null, null, 'active', 'high', '2024-01-10', 'hourly', 450.00, null, 18000.00, 15000.00, 3000.00, 'Projeto de grande porte em andamento'),
...
INSERT INTO tasks (id, law_firm_id, matter_id, title, description, task_type, priority, status, 
                  due_date, is_billable, estimated_hours) VALUES

-- Tasks for active matters
('77777777-7777-7777-7777-777777777001', '123e4567-e89b-12d3-a456-426614174000', '55555555-5555-5555-5555-555555555001', 'Preparar petição inicial', 'Elaborar petição inicial da reclamação trabalhista', 'general', 'high', 'completed', '2024-01-20', true, 4.0),

('77777777-7777-7777-7777-777777777002', '123e4567-e89b-12d3-a456-426614174000', '55555555-5555-5555-5555-555555555001', 'Audiência inicial', 'Comparecer à audiência inicial', 'court_date', 'high', 'pending', '2024-04-15', true, 2.0),

('77777777-7777-7777-7777-777777777003', '123e4567-e89b-12d3-a456-426614174000', '55555555-5555-5555-5555-555555555003', 'Análise do processo', 'Analisar autos do processo criminal', 'document_review', 'urgent', 'in_progress', '2024-03-20', true, 6.0),

('77777777-7777-7777-7777-777777777004', '123e4567-e89b-12d3-a456-426614174000', '55555555-5555-5555-5555-555555555004', 'Citação do réu', 'Acompanhar citação da empresa devedora', 'general', 'medium', 'pending', '2024-04-01', true, 1.0),

('77777777-7777-7777-7777-777777777005', '234e4567-e89b-12d3-a456-426614174001', '66666666-6666-6666-6666-666666666001', 'Reunião com cliente', 'Reunião para definir estratégia de reestruturação', 'client_meeting', 'high', 'completed', '2024-01-15', true, 3.0),

('77777777-7777-7777-7777-777777777006', '234e4567-e89b-12d3-a456-426614174001', '66666666-6666-6666-6666-666666666002', 'Recurso TRF', 'Preparar recurso para o TRF', 'deadline', 'urgent', 'in_progress', '2024-03-25', true, 8.0);
